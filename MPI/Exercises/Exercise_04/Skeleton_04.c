...
int main(int argc, char* argv[]){
    ...
    for(count = 1; count < ...; count++)
      {
    /* Insert the MPI communication function here. We want to send the content of the variable a to the process on out left, and to receive in our variable b the message from the process on our right. Can we do that with just one MPI function?
