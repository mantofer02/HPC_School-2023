...
int main(int argc, char *argv[])
{
  ...
  cout << "I am world_rank " << world_rank << " in MPI_COMM_WORLD and world_rank " << cart_rank << " in the cartesian communicator" << endl;
  ...
  /*Neighbour's average */
  avg = (float) sum / 5;
  cout << "Cart rank " << cart_rank << " (" << coords[0] << "," << coords[1] << "), neighbours average: " << avg <<endl;
  ...
  if (row_rank == 0) {
    ...
    cout << "Row " << coords[0] << ", row average: " << avg << endl;
  }
  ...
  if (col_rank == 0) {
    ...
    cout << "Column " << coords[1] << ", column average: " << avg << endl;
  }
